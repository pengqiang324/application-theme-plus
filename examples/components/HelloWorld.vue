<template>
  <Search>
    <el-form :model="form" :rules="rules" ref="searchForm" @keyup.enter="search('searchForm')">
      <el-row>
        <el-col :span="8">
        ...
        <el-col :span="8">
          <el-form-item label="所属行业:">
            <el-select v-model="form.industryCode">
              <el-option v-for="item in industryList" :label="item.showName" :value="item.code" :key="item.id">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
